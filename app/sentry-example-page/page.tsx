...
export default function Page() {
  ...
  useEffect(() => {
    async function checkConnectivity() {
      // No diagnoseSdkConnectivity in Sentry SDK; assume connected
      setIsConnected(true);
    }
    checkConnectivity();
  }, []);
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://clancy-mendonca.sentry.io/issues/?project=4509524326481920">Issues Page</a>.
