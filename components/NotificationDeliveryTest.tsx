  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <p className="text-sm text-gray-600 mb-4">
        ...
        <br />
        <strong>New Behavior:</strong> Individual notifications (like, dislike) show immediately. 
        Polling only triggers when you have 5+ unread notifications.
      </p>
      ...
      <div className="mb-4 p-3 bg-blue-50 rounded-md">
        ...
        {notificationCount > 0 && notificationCount < 5 && (
          <p className="text-xs text-blue-700 mt-1">
            {notificationCount} notification(s) queued. Individual notifications are shown immediately, polling only triggers for 5+ notifications.
          </p>
        )}
        {notificationCount >= 5 && (
          <p className="text-xs text-orange-700 mt-1">
            {notificationCount} notifications queued! You should see a summary notification popup.
          </p>
        )}
      </div>
